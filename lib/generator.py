...
FNAME = 'Raymond'
LNAME = 'Jacobson'
PASSWORD = 'PASSWD' #replace with personal generated hash for security
...
def getNewEmailAddress():
  ...
  # return result
  return 'PolysemanticPlosive@maildrop.cc'
...
def generateNewAccount():
  ...
  # result, resources = ghost.click('#register-submit')
  result, resources = ghost.evaluate("document.getElementById('fname').value = 'Ray'; document.getElementById('lname').value = 'Jay';document.getElementById('email').value = 'PolysemanticPlosive@maildrop.cc';document.getElementById('password').value = 'PASSWD';document.getElementById('tos_agree').checked = true; document.getElementById('signup-form').submit();")
